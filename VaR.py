...
print('\n Historical method:')
#We open the file
with open(r'C:\Users\Elias\Documents\Berkeley 2018-2019\Fall Semester\Elective\IND 221 Introduction to Financial Engineering\Assignment 4\^DJI.csv', newline = '') as file :
